  ...
  return (
    ...
    >
      <g>
        ...
        ></path>
        <path
          d="M49 39c-2.206 0-4 1.794-4 4s1.794 4 4 4 4-1.794 4-4-1.794-4-4-4zm0 6c-1.103 0-2-.897-2-2s.897-2 2-2 2 .897 2 2-.897 2-2 2zM49.11 16.768l-.625.375a1 1 0 0 0-.086 1.658l4 3a1 1 0 0 0 1.155.032l.176-.117a14.046 14.046 0 0 0 6.234-10.715h1.316c.692 0 1.31-.413 1.574-1.052a1.699 1.699 0 0 0-.308-1.793L57.98 2.014a2.469 2.469 0 0 0-1.999-1.005h-.001a2.466 2.466 0 0 0-1.998 1.007l-4.538 6.11a1.715 1.715 0 0 0-.312 1.811A1.716 1.716 0 0 0 50.723 11h1.388a6.227 6.227 0 0 1-3.001 5.768zm4.889-6.77a.977.977 0 0 0-.072-.327l-.019-.046-.001-.002c-.09-.223-.253-.396-.45-.503s0-.001-.001-.001a1.027 1.027 0 0 0-.175-.073A1.217 1.217 0 0 0 52.962 9h-1.676l4.302-5.793c.127-.172.301-.198.393-.198s.266.026.395.198L60.684 9H59a1 1 0 0 0-1 1c0 3.883-1.851 7.499-4.975 9.77l-2.265-1.7a8.228 8.228 0 0 0 3.239-8.072z"
          fill="#000000"
          opacity="1"
          data-original="#000000"
          className="hovered-path"
